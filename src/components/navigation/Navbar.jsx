...
export function Navbar() {
  return (
    <Popover className="relative bg-white ">
      <div
        className="absolute inset-0 z-30 pointer-events-none shadow"
        aria-hidden="true"
      />
            ...
            <div className="py-6 px-5">
              <div className="max-w-screen-lg mx-auto">
                <div className="bg-white px-5">
                  <a
                    href="#"
                    className="text-[#DB1A40] font-semibold py-2 block"
                  >
                    Iniciar sesión
                  </a>
                  <a
                ...
                <div className="bg-[#DB1A40] p-4">
                  <a
                    href="#"
                    className="text-white font-semibold block border-b border-red-500 pb-4"
                  >
                    SNACKS
                  </a>
                  <a
                  ...
                  <a
                    href="#"
                    className="text-white font-bold block border-b border-red-500 pb-4"
                  >
                    BEBIDAS
                  </a>
